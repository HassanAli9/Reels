...
class PlaylistVC: UIViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        let image = UIImage(named: "Internet_connection")
...
extension PlaylistVC {
    ...
    func setupVM() {
        ...
        playlistVM.bindDataFromVMToVC = { [weak self] in
            self?.onSuccess()
        }
        playlistVM.bindErrorFromVMToVC = { [weak self] in
            self?.onFailure()
        }
        playlistVM.bindConnectionState = { [weak self] in
